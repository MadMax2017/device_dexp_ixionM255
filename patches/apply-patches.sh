...
cd ../../..
cd frameworks/av
git apply -v ../../device/dexp/ixionM255/patches/0006-fix-access-wvm-to-ReadOptions.patch
git apply -v ../../device/dexp/ixionM255/patches/0007-Disable-usage-of-get_capture_position.patch
git apply -v ../../device/dexp/ixionM255/patches/0008-Partial-Revert-Camera1-API-Support-SW-encoders-for-n.patch
git apply -v ../../device/dexp/ixionM255/patches/0009-add-mtk-color-format-support.patch
git apply -v ../../device/dexp/ixionM255/patches/0013-fix-_ZN7android16MediaBufferGroup14acquire_bufferEPP.patch
cd ../..
cd system/netd
